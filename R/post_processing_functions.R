    ...
    tidy_mod %>%
        mutate(
            term = case_when(term == "(Intercept)" ~ "Intercept",
                             ...
                             term == "group1:valence1:Cong1" ~ "group x valence x congruency",
                             term == "group1:Cong1:block1" ~ "group x congruency x block",
                             term == "group1:valence1:Cong1:block1" ~ "group x valence x congruency x block",
                             term == "valence1:Cong1:block1" ~ "valence x congruency x block",
                             term == "group1:valence1" ~ "valence x group",
                             term == "block1:s1_color1" ~ "block x color",
                             term == "group1:block1:s1_color1" ~ "group x block x color",
                             ...
                             term == "sd__s1_color1" ~ paste0("\u03C3", " color")),
...
# from a fitted model get cook distance and dfbeta in a tidy way. A wrapper
